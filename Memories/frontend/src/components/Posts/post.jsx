...
const post = (props) => {
  return (
    <div className=' bg-zinc-700 flex flex-col justify-center rounded-md h-110 w-80 max-w-90- relative overflow-clip'>
      <img className='h-65 static object-cover rounded-md bg-black opacity-70' src={props.data.ImageUrl} />
      ...
      <div className=' static flex justify-between px-2 py-2 mx-5 mt-1'>{props.data.tags}</div>
      <h1 className=' static text-2xl font-semibold flex justify-between px-2 py-2 mx-5'>{props.data.title}</h1>
      <div className=' text-xl font-medium flex px-2 mx-5'>{props.data.message}</div>
