...
const Profile = (user) => {
  ...
  return (
    <div className="relative flex justify-end items-center gap-2 w-1/2">
      ...
      <div className={`-right-8 absolute bg-[rgba(84,84,84,0.6)] shadow-xl backdrop-blur-sm p-2 rounded-md w-[200px] h-auto ${show ? 'top-18' : '-top-40'} flex-col justify-start items-start gap-2 transition-(top) duration-250 ease-in-out`}>
