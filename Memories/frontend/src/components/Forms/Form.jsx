...
const Form = () => {
  ...
  return (
    <>
      <div className='hidden md:flex flex-col justify-center items-center gap-2 bg-zinc-600 shadow-xl mt-5 mr-10 md:mr-20 2xl:mr-55 xl:mr-25 p-3 rounded-md w-55 lg:w-90 max-w-130 h-115 xl:h-120 max-h-150'>
